...
const rules = {
  ...
  create: [body('title').trim().notEmpty().withMessage('Judul modul konstruksi wajib diisi')],

  /** Digunakan pada PUT /modules/:id */
  update: [body('title').trim().notEmpty().withMessage('Judul modul konstruksi wajib diisi')],
};
